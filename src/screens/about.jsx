...
const About = () => {
  ...
  return (
    <div id="aboutPage">
      ...
      <section id="about-page-content" className="container-fluid p-0 section-with-animations" >
        <div className="row p-0">
            ...
            <div id="features3">
              <div className="mt-5">
                <section className="slide-up">
                  <p className="title text-start text-muted slide-up-text">Proven with 10K+ Results</p>
                </section>
                <section className="slide-up">
                  <p className="mb-0 text-muted slide-up-text">
                    Eden Utilities has successfully completed
                    over 1,552 tenders and 652 audits. With 6,523 meters managed and 182 happy customers,
                    our growth is a testament to Mark’s strategic leadership and unwavering commitment
                    to excellence.
                  </p>
                </section>
              </div>
              ...
              <div className="mt-5">
                <section className="slide-up">
                  <p className="title text-start text-muted slide-up-text">less than 10%</p>
                </section>
                <section className="slide-up">
                  <p className="mb-0 text-muted slide-up-text">Maintaining less than 10% audit error rate</p>
                </section>
              </div>
            </div>
          </div>
          ...
          <div id="features">
            <div className="feature-list position-relative">
              {featuresData.map((item, idx) => (
                ...
                >
                  <p className="feature-text">{item.feature}</p>
                  <div
      ...
      <div id="partnership" className="container-fluid p-0 section-with-animations">
        <div className="content-width px-4 px-md-4">
          <div className="slide-up">
