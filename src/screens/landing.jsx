...
const LandingPage = () => {
  ...
  useGSAP(() => {
    ...
    let scrollStartValue = "top center"; // default
  ...
  useEffect(() => {
    ...
    gsap.fromTo(
      ".dot",
      { y: 0 }, // Start with dots in normal position
      {
        y: -10, // Move the dots up by 10px
        ...
        scrollTrigger: {
          ...
          start: "top bottom", // Animation triggers when the top of the section hits the bottom of the viewport
